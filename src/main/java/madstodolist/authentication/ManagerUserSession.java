...
public class ManagerUserSession {
    ...
    // desde la URL
    public void logearUsuario(HttpSession session, String idUsuario) {
    ...
    public boolean comprobarUsuarioLogeado(HttpSession session, String idUsuario) {
        String idUsuarioLogeado =  (String) session.getAttribute("idUsuarioLogeado");
