...
import madstodolist.data.LoginData;
import madstodolist.data.RegistroData;
...
public class LoginController {
    ...
    public String loginForm(Model model) {
        ...
        //si no hay usuarios registrados, crea uno por defecto
    ...
    public String loginSubmit(@ModelAttribute LoginData loginData, Model model, HttpSession session) {
        ...
        if (loginStatus == UsuarioService.LoginStatus.LOGIN_OK) {
            ...
            return "redirect:/" + usuario.getId() + "/inicio";
   ...
   private void usuarioPorDefecto(){
         Usuario usuario = new Usuario("admin@admin.com");
            usuario.setPassword("admin");
            usuario.setFechaNacimiento(Date.from(new Date().toInstant()));
